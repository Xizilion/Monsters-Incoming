...
public class TowerManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < towerNames.Count; i++)
        {
            ...
            GameObject tower = (GameObject)Instantiate(towerPrefabs[i], new Vector3(0, -200f, 0), Quaternion.identity);
            ...
            towerBase.Add(tower.GetComponentInChildren<TowerBase>());
            //add upgrade properties to list above
            towerUpgrade.Add(tower.GetComponentInChildren<Upgrade>());
