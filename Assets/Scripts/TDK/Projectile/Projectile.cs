...
public class Projectile : MonoBehaviour
{
    ...
    IEnumerator OnSpawn()
    {
        //wait until Start() has been executed the first time this projectile spawns
    ...
    void Straight()
    {
        ...
        if (followEnemy && target && target.gameObject.activeInHierarchy == true)
        {
    ...
    IEnumerator OnTriggerEnter(Collider hitCol)
    {
        ...
        //reset projectile position back to the impact position
        transform.position = colGO.transform.position;
