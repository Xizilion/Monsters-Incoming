...
public class Properties : MonoBehaviour
{
    ...
    public UISlider healthbar;        //3D health indicator slider
    public Shield shield;       //absorb shield properties
    private Transform barParentTrans; //bar parent transform
    ...
    IEnumerator OnSpawn()
    {
        ...
        //foreach (var transf in gameObject.GetComponentsInChildren<Transform>())
        //{
        //    if (transf.gameObject.tag == "Model")
        //    {
        //        Debug.Log("Found Child reseting is position");
        //        Debug.Log("Posicao do cabrao: X: " + transf.localPosition.x + " Y: " + transf.localPosition.y + " Z:" + transf.localPosition.z);
	...
	public void SetUnitFrame()
    {
        ...
        if (shield.bar)
            shield.bar.sliderValue = shield.value / shield.maxValue;
    }
    ...
    IEnumerator RemoveEnemy()
    {
        ...
        if (healthbar)
            healthbar.sliderValue = 1;
        if (shield.bar)
            shield.bar.sliderValue = 1;
...
public class Shield
{
    ...
    public UISlider bar;                //3d shield bar indicator
